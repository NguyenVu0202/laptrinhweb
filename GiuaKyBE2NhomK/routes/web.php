...
Route::get('hacker/xss', [CrudUserController::class, 'indexhacker']);

Route::get('listfavorite', [CrudUserController::class, 'listFavo'])->name('user.listFavoriteIndex');
Route::get('listpost', [CrudUserController::class, 'listpost'])->name('user.listPostIndex');