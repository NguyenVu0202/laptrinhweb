                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('user.PostUpdatetUser') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group mb-3">
                            <div class="row">
                                    <div class="col-md-3"><span>Favorites</span></div>
                                    <div class="col-md-9"><input type="text" id="favorities" class="form-control" name="favorities"
                                    value="{!! $user->favorities !!}" required autofocus></div>
                                </div>
